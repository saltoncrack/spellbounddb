...
try {
    ...
    $username = htmlspecialchars($row['username']); // Fetch the username for display
...
<body class="body">
    <div class="nav" id="nav">
        <nav class="nav__content">
            ...
            <div class="nav__list">
                <a href="studentdash.php" class="nav__link active-link">
                    <i class='bx bx-grid-alt'></i>
                    <span class="nav__name">Dashboard</span>
                </a>
                <a href="#" class="nav__link">
                    <i class='bx bx-file'></i>
                    <span class="nav__name">Play Game</span>
                </a>
                <a href="#" class="nav__link">
        ...
        <section class="hero-without-image-2">
            <div class="container-2">
                <div class="hero-wrapper-two-2">
                    ...
                    <a data-w-id="77554306-e4d7-7658-2a1c-d91ce0dc5687" href="game/start.html" class="button-primary-2 w-button">START</a>
                </div>
            </div>
        </section>
